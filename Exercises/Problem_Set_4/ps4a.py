...
WORDLIST_FILENAME = "C:/Users/Mario/Documents/GitHub/0010_MOOC_Introduction_to_CS_and_Programming_Using_Python/Exercises/Problem_Set_4/words.txt"
...
def getWordScore(word, n):
    ...
    #Multiply by length of the word
    score *= len(word)
    
    #Bonus points if all letters are used
    if len(word) == n:
        score += 50
...
def isValidWord(word, hand, wordList):
    ...
    for letter in word:
        # If letter not in hand, or in hand with 0 count
        if temp_hand.get(letter,0) == 0:
            return False
        # else decrement letter count by 1
        else:
            temp_hand[letter] -= 1
...
def playGame(wordList):
    ...
    while True:
        ...
        if choice == 'r' and last_hand == None:
